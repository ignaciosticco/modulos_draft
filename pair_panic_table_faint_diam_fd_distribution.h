...
PairStyle(panic/table/faint/fd/diam/distribution,PairPanicTableFaintDiamFdDistribution)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FAINT_DIAM_FD_DISTRIBUTION_H
#define LMP_PAIR_PANIC_TABLE_FAINT_DIAM_FD_DISTRIBUTION_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFaintDiamFdDistribution : public Pair {
 public:
  PairPanicTableFaintDiamFdDistribution(class LAMMPS *);
  virtual ~PairPanicTableFaintDiamFdDistribution();
 ...
 protected:
  ...
  double     umbral_faint = 4030.0;       // Sticco Cornes 22 Jun
  int     nrun_faint = 300;       // Sticco Cornes 22 Jun

  double vector_compforce[100000];       // Sticco Cornes 22 Jun
  double vector_vd_x[100000];       // Sticco Cornes 22 Jun
  double vector_vd_y[100000];       // Sticco Cornes 22 Jun
  int acum_comp_force[100000];       // Sticco Cornes 22 Jun
  ...
  void compute_compression_force(int i, Table *, double vector_vd_x[], double vector_vd_y[], double vector_compforce[], int acum_comp_force[]);
  void initialize_acum_comp_force(int acum_comp_force[]);
