...
PairStyle(panic/table/faint/fdmodified,PairPanicTableFaintFdmodified)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FAINT_FDMODIFIED_H
#define LMP_PAIR_PANIC_TABLE_FAINT_FDMODIFIED_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFaintFdmodified : public Pair {
 public:
  PairPanicTableFaintFdmodified(class LAMMPS *);
  virtual ~PairPanicTableFaintFdmodified();
 ...
 protected:
  ...
  double A = 2000.0;        // Sticco Cornes 22 Jun
