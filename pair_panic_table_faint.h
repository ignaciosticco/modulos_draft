...
PairStyle(panic/table/faint,PairPanicTableFaint)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FAINT_H
#define LMP_PAIR_PANIC_TABLE_FAINT_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFaint : public Pair {
 public:
  PairPanicTableFaint(class LAMMPS *);
  virtual ~PairPanicTableFaint();
