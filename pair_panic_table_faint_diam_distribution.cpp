...
#include <stdlib.h>
#include <string.h>
#include "pair_panic_table_faint_diam_distribution.h"
#include "atom.h"
#include "force.h"
#include "comm.h"
...
PairPanicTableFaintDiamDistribution::PairPanicTableFaintDiamDistribution(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = NULL;
}
...
PairPanicTableFaintDiamDistribution::~PairPanicTableFaintDiamDistribution()
{
  if (copymode) return;
...
void PairPanicTableFaintDiamDistribution::compute(int eflag, int vflag)
{
...
void PairPanicTableFaintDiamDistribution::allocate()
{
  allocated = 1;
...
void PairPanicTableFaintDiamDistribution::settings(int narg, char **arg)
{
...
void PairPanicTableFaintDiamDistribution::coeff(int narg, char **arg)
{
...
double PairPanicTableFaintDiamDistribution::init_one(int i, int j)
{
...
void PairPanicTableFaintDiamDistribution::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairPanicTableFaintDiamDistribution::bcast_table(Table *tb)
{
...
void PairPanicTableFaintDiamDistribution::spline_table(Table *tb)
{
...
void PairPanicTableFaintDiamDistribution::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairPanicTableFaintDiamDistribution::compute_table(Table *tb)
{
  int tlm1 = tablength-1;
...
void PairPanicTableFaintDiamDistribution::null_table(Table *tb)
{
...
void PairPanicTableFaintDiamDistribution::free_table(Table *tb)
{
...
void PairPanicTableFaintDiamDistribution::spline(double *x, double *y, int n,
...
double PairPanicTableFaintDiamDistribution::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo,khi,k;
  double h,b,a,y;
...
void PairPanicTableFaintDiamDistribution::write_restart(FILE *fp)
{
...
void PairPanicTableFaintDiamDistribution::read_restart(FILE *fp)
{
...
void PairPanicTableFaintDiamDistribution::write_restart_settings(FILE *fp)
{
...
void PairPanicTableFaintDiamDistribution::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairPanicTableFaintDiamDistribution::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairPanicTableFaintDiamDistribution::extract(const char *str, int &dim)
{
...
void PairPanicTableFaintDiamDistribution::initialize_acum_comp_force(int acum_comp_force[]){
...
void PairPanicTableFaintDiamDistribution::wall_extract(Table *tb, char *line,FILE *fp)
{
  int  i,n;
  char word[MAXLINE];
...
void PairPanicTableFaintDiamDistribution::compute_wallforce(double x, double y, double vx, double vy, double force_wall[], Table *tb, double rad){
...
void PairPanicTableFaintDiamDistribution::compute_desiredforce(double x, double y, double vx, double vy, double* force_desired, double vd, Table *tb){
...
void PairPanicTableFaintDiamDistribution::compute_compression_force(int i, Table *tb, double vector_vd_x[], double vector_vd_y[], double vector_compforce[], int acum_comp_force[]){
...
void PairPanicTableFaintDiamDistribution::search_near_opening(int i, double vector_vd_x[], double vector_vd_y[], Table *tb){
