...
PairStyle(panic/table/fdmodified,PairPanicTableFdmodified)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FDMODIFIED_H
#define LMP_PAIR_PANIC_TABLE_FDMODIFIED_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFdmodified : public Pair {
 public:
  PairPanicTableFdmodified(class LAMMPS *);
  virtual ~PairPanicTableFdmodified();
