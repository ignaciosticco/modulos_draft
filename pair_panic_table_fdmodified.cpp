...
#include <stdlib.h>
#include <string.h>
#include "pair_panic_table_fdmodified.h"
#include "atom.h"
#include "force.h"
#include "comm.h"
...
PairPanicTableFdmodified::PairPanicTableFdmodified(LAMMPS *lmp) : Pair(lmp)
{
  ntables = 0;
  tables = NULL;
}
...
PairPanicTableFdmodified::~PairPanicTableFdmodified()
{
  if (copymode) return;
...
void PairPanicTableFdmodified::compute(int eflag, int vflag)
{
...
void PairPanicTableFdmodified::allocate()
{
  allocated = 1;
...
void PairPanicTableFdmodified::settings(int narg, char **arg)
{
...
void PairPanicTableFdmodified::coeff(int narg, char **arg)
{
...
double PairPanicTableFdmodified::init_one(int i, int j)
{
...
void PairPanicTableFdmodified::read_table(Table *tb, char *file, char *keyword)
{
  char line[MAXLINE];
...
void PairPanicTableFdmodified::bcast_table(Table *tb)
{
...
void PairPanicTableFdmodified::spline_table(Table *tb)
{
...
void PairPanicTableFdmodified::param_extract(Table *tb, char *line)
{
  tb->ninput = 0;
  tb->rflag = NONE;
  tb->fpflag = 0;
...
void PairPanicTableFdmodified::compute_table(Table *tb)
{
  int tlm1 = tablength-1;
...
void PairPanicTableFdmodified::null_table(Table *tb)
{
...
void PairPanicTableFdmodified::free_table(Table *tb)
{
...
void PairPanicTableFdmodified::spline(double *x, double *y, int n,
...
double PairPanicTableFdmodified::splint(double *xa, double *ya, double *y2a, int n, double x)
{
  int klo,khi,k;
  double h,b,a,y;
...
void PairPanicTableFdmodified::write_restart(FILE *fp)
{
...
void PairPanicTableFdmodified::read_restart(FILE *fp)
{
...
void PairPanicTableFdmodified::write_restart_settings(FILE *fp)
{
...
void PairPanicTableFdmodified::read_restart_settings(FILE *fp)
{
  if (comm->me == 0) {
...
double PairPanicTableFdmodified::single(int i, int j, int itype, int jtype, double rsq,
...
void *PairPanicTableFdmodified::extract(const char *str, int &dim)
{
...
void PairPanicTableFdmodified::wall_extract(Table *tb, char *line,FILE *fp)
{
  int  i,n;
  char word[MAXLINE];
...
void PairPanicTableFdmodified::compute_wallforce(double x, double y, double vx, double vy, double force_wall[], Table *tb){
...
void PairPanicTableFdmodified::compute_desiredforce(double x, double y, double vx, double vy, double* force_desired, double vd, Table *tb){
