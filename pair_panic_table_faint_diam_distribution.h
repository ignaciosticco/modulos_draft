...
PairStyle(panic/table/faint/diam/distribution,PairPanicTableFaintDiamDistribution)

#else

#ifndef LMP_PAIR_PANIC_TABLE_FAINT_DIAM_DISTRIBUTION_H
#define LMP_PAIR_PANIC_TABLE_FAINT_DIAM_DISTRIBUTION_H

#include "pair.h"

namespace LAMMPS_NS {

class PairPanicTableFaintDiamDistribution : public Pair {
 public:
  PairPanicTableFaintDiamDistribution(class LAMMPS *);
  virtual ~PairPanicTableFaintDiamDistribution();
